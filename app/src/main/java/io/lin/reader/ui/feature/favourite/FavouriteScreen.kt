...
fun FavouriteScreen(
    ...
    viewModel: FavouriteScreenViewModel = viewModel(factory = ViewModelProvider.Factory),
    ...
    Scaffold(
        ...
        topBar = {
            FavouriteScreenTopBar(
                ...
                onSortMethodChange = shelfPreferences::updateSeriesSortMethod,
                onToggleOrder = shelfPreferences::toggleSeriesSortAscending,
                onRemoveAllFavourites = {
                    ...
                    if (uiState.groupedFavorites.isEmpty()) {
                        ...
                        onResult = { count ->
                            val text =
                                appContext.getString(R.string.favourite_favourite_cleared, count)
                            scope.launch {
                                snackbarHostState.showSnackbar(text)
                            }
                        }
                        ...
                        LazyRow(
                            ...
                            items(
                                ...
                                Box(contentAlignment = Alignment.TopCenter) {
                                    io.lin.reader.ui.feature.shelf.components.VolumeBox(
                                        volume = volume,
